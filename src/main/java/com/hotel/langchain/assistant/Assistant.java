...
public interface Assistant {
    ...
    @SystemMessage("""
        ...
        Когато клиентът иска да направи резервация или настаняване и не е посочил изрично начална и крайна дата, ВИНАГИ извикай инструмента getAvailableRoomsByDates с null за датите. Не питай за дати с текст и не измисляй дати - календарът се показва автоматично.
